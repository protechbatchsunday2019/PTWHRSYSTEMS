Feature: Net Pay Calculation Test
 	 ...
 	 Scenario: Get net pay for an employee with hourly rate $15 and total hour 40 .
	...
	Scenario: Get net pay for an employee with hourly rate $60 and total hour 40 .
    Given I use the HR system to calculate netpay pay of an employee.
	...
	Scenario: Get net pay for an employee with hourly rate $80 and total hour 40 .
    Given I use the HR system to calculate netpay pay of an employee.
	...
	Scenario: Get net pay for an employee with hourly rate $14 and total hour 40 .
    Given I use the HR system to calculate netpay pay of an employee.
    When I enter hourly rate as $14.
    And I expect Error Message 'Please enter a Rate between 15 to 80...'.
       #Result will be:- No result until I entered a hourly rate between 15 to 80 . 
       
	Scenario: Get net pay for an employee with hourly rate $85 and total hour 40 .
    Given I use the HR system to calculate netpay pay of an employee.
    When I enter hourly rate as $85.
    And I expect Error Message 'Please enter a Rate between 15 to 80...'.
       #Result will be:- No result until I entered a hourly rate between 15 to 80.
       
	Scenario: Get net pay for an employee with hourly rate $40 and total hour 45 .
    Given I use the HR system to calculate netpay pay of an employee.
    When I enter hourly rate as $ 40 .
    And I enter total hour 45 .
    And I expect Error Message 'Please enter a hour between 0 to 40...'.
       #Result will be:- No result until I entered a total hour between 0 to 40 .
